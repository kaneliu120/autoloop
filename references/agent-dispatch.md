...
| T3 Iterate | optimizer | kpi-evaluator | KPI达成/策略有效性/副作用 |
| T4 Generate | generator | quality-checker | 内容质量/格式规范/变量覆盖 |
| T5 Deliver | implementer | code-reviewer | 安全性/可靠性/可维护性 |
| T6 Quality | code-reviewer(修复) | security/reliability/maintainability-reviewer | 同T5 |
| T7 Optimize | optimizer | architecture/performance/stability-reviewer | 架构/性能/稳定性 |
