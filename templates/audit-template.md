...
|------|--------|--------|------|--------|------|
| 安全性 | {N}/10 | {N}/10 | {目标阈值见 protocols/quality-gates.md T6 门禁} | +{N} | 达标/未达标 |
| 可靠性 | {N}/10 | {N}/10 | {目标阈值见 protocols/quality-gates.md T6 门禁} | +{N} | 达标/未达标 |
| 可维护性 | {N}/10 | {N}/10 | {目标阈值见 protocols/quality-gates.md T6 门禁} | +{N} | 达标/未达标 |
...
检测命令和验证方法见 `protocols/enterprise-standard.md` 中各维度的"检测命令"章节。语法验证使用 `autoloop-plan.md` 中收集的 `syntax_check_cmd`。验证层级说明见 `protocols/quality-gates.md` 验证层级章节。
