...
|----|---------------|------|------|--------|------|------|
| S001 | {路径} | {行} | SQL注入 | P1 | 待修复/已修复 | {描述} |

### 可靠性问题

| ID | 文件 | 行号 | 类型 | 优先级 | 状态 | 描述 |
|----|------|------|------|--------|------|------|
| R001 | {路径} | {行} | 静默失败 | P1 | 待修复 | `except: pass` |

### 可维护性问题

| ID | 文件 | 行号 | 类型 | 优先级 | 状态 | 描述 |
|----|------|------|------|--------|------|------|
| M001 | {路径} | {行} | any 类型 | P2 | 待修复 | {描述} |

### 架构问题

| ID | 影响范围 | 类型 | 优先级 | 状态 | 描述 |
|----|---------|------|--------|------|------|
| A001 | {文件/模块} | 循环依赖 | P1 | 待修复 | {描述} |

### 性能问题

| ID | 文件 | 行号 | 类型 | 预期收益 | 状态 | 描述 |
|----|------|------|------|---------|------|------|
| P001 | {路径} | {行} | N+1查询 | 减少N次查询/请求 | 待修复 | {描述} |

### 稳定性问题

| ID | 文件 | 类型 | 优先级 | 状态 | 描述 |
|----|------|------|--------|------|------|
| ST001 | {路径} | 无降级 | P1 | 待修复 | {Redis 失败无降级} |
...
|----|---------|---------|---------|---------|-------------|
| S001 | {时间} | {修复描述} | {文件路径} | py_compile 通过 | 否 |
...
|------|---------|------|--------|------|---------|
| R1 | {问题} | {subagent/验证步骤} | P1/P2/P3 | 新发现/已修复/待处理/遗留 | {为什么} |

## 策略评估（REFLECT 第 2 层 — 策略效果知识库）

| 轮次 | 策略 | 效果评分(1-5) | 分数变化 | 保持/避免 | 原因 |
|------|------|-------------|---------|----------|------|
| R1 | {策略描述} | {1-5} | {+/-分数} | 保持/避免 | {为什么有效/无效} |
